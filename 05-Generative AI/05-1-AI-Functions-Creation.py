...
# MAGIC 1. use the function "et_customer_details", 
# MAGIC 2. combine it with the ai_query function we learned in the prior notebook 
# MAGIC 3. integrate the written prompt from step 13 for the LLM behavior into it
# MAGIC
# MAGIC Feel free to discuss with your colleagues to make sure everyone is aligned on this.
# MAGIC
# MAGIC # **_Task 9 End_**
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=984752964297111&notebook=%2F05-Generative-AI%2F05.1-AI-Functions-Creation&demo_name=lakehouse-fsi-fraud&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-fsi-fraud%2F05-Generative-AI%2F05.1-AI-Functions-Creation&version=1&user_hash=086247655aad7f847fc5af0bced92d31b6454844129a39a1b73eef221886867a">
